...
fb_top_plot <- fb_ads |>
  ...
  ggplot(aes(x = impressions_millions, 
             y = reorder(cand_name_last, impressions_millions),  # Reorder y-axis by impressions
             fill = party)) +  # Fill color based on party
  geom_col(na.rm = TRUE) +  # Use geom_col() for pre-calculated values
  labs(x = "Impressions (in millions)", 
