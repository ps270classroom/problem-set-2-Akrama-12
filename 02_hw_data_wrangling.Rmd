...
plot_q3 <- fb_ads |>
  ...
  ggplot(data = fb_ads, mapping = aes(x = impressions_millions, y= cand_name_last)) +
  geom_histogram(stat = "identity", binwidth = 20, color = "black", aes(fill= party), na.rm = TRUE) +
